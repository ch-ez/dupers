<script>
    ...
    import BrightButton from '$lib/components/btn/BrightButton.svelte';
    import VersionCard from '$lib/components/cards/VersionCard.svelte';
    ...
    <main class="container">
        ...
        <header class="hero">
            ...
            <div class="social-links">
                ...
                <DarkButton href="https://github.com/YAYLOLDEV/du-addon-public">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href={contributor.html_url} target="_blank" rel="noopener noreferrer"
                               class="contributor-mini">
                                ...
                                <div class="contributor-tooltip">
                                    ...
                                    <span
                                      class="tooltip-commits">{contributor.contributions} {contributor.contributions === 1 ? 'commit' : 'commits'}</span>
                                </div>
                            </a>
                        {/each}
                    </div>
